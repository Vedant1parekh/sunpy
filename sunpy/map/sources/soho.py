...
class MDISynopticMap(MDIMap):
    ...
    You just have toe enter the date and it will give the map.
    
    References
    ----------
    * `SOHO Mission Page <https://sohowww.nascom.nasa.gov/>`_
    * `MDI sypmotic charts <http://soi.stanford.edu/magnetic/index6.html>`_
    * `Magnetogram Synoptic Map Images <https://gong.nso.edu/data/magmap/>`_
